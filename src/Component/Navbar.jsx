...
function Navbar() {
  ...
  return (<>
    <div className="px-3 py-2 w-full bg-gradient-to-r from-orange-400 to-amber-500 flex justify-between items-center fixed shadow-md z-50">
      <div
        onClick={() => navigator('/')}
        className="flex items-center md:space-x-3 space-x-1 cursor-pointer text-nowrap"
      >
        <img src={logo} className="md:w-8 md:h-8 w-8 h-8 drop-shadow-md" alt="logo" />

        <p className="hidden md:block md:text-3xl text-xl font-serif font-semibold tracking-wide 
      ...
      <div className="text-end space-x-4">
        <button
          onClick={() => navigator('/customizeOrder')}
